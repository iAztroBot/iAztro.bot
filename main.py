...
moderators = ["iMooseMoo","LocustLo","xSquishii","Soup____","iAztro"]
...
class Bot(BaseBot):
    async def on_start(self, session_metadata: SessionMetadata) -> None:
        print("working")
        await self.highrise.walk_to(Position(1.5 , 0.0 , 6.5 ,"FrontLeft"))
    async def on_user_join(self, user: User, position: Position | AnchorPosition) -> None:
        print(f"{user.username} entrou na sala")   
        await self.highrise.chat(f"{user.username} Welcome in! Sit in any open seat to play!")
    ...
    async def on_chat(self, user: User, message: str) -> None:
        ...
        if        message.startswith("Help") or      message.startswith("/help") or      message.startswith("!help") or message.startswith("help"):
            await self.highrise.chat(f"/emote list | /peoples | /emotes  | /marry me? | /play /fish /userinfo @ | !emoteall | !tele @ | !summom @ | !kick @ | !tele z,y,x | !tele user z,y,x | !fit [1-11]")
